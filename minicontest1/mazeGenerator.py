...
def add_pacman_stuff(maze, max_food=60, max_capsules=0, toskip=0):
  """
  ...
  # TODO Support multiple pacmen, possibly in different starting positions
  # Also maybe multiple ghosts
